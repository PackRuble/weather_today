...
class AppThemeScheme {
  ...
  static FlexSubThemesData get _subThemesDataDark => _subThemesDataLight.copyWith(blendOnLevel: 10);
  ...
  static PageTransitionsTheme get pageTransitionsTheme {
    const builder = ZoomPageTransitionsBuilder(allowEnterRouteSnapshotting: false);
  ...
  static FlexColorScheme dark({
    ...
    required bool swapDarkMainAndContainerColors, // замена Main Colors на их Container
    ...
    colors: usedTheme.light.defaultError.toDark(darkLevel, swapDarkMainAndContainerColors),
    surfaceMode: FlexSurfaceMode.highScaffoldLowSurface,
    blendLevel: 10,
    appBarOpacity: 0.90,
    appBarElevation: 8.0,
