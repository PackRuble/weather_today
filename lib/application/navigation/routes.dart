...
class DismissibleRoute extends CustomRoute {
  DismissibleRoute({required super.page}) : super(customRouteBuilder: _dismissiblePageRouteBuilder);
  ...
  static TransparentRoute<T> _dismissiblePageRouteBuilder<T>(
    ...
    builder: (context) => MyDismissiblePage(
      ...
      dismissThresholds: const {DismissiblePageDismissDirection.startToEnd: 0.3},
