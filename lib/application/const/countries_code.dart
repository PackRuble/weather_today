...
///
/// Kosovo uses the user-assigned country code XK, which is not part of the
/// ISO standard, but in use by several multinational organizations.
const Map<String, String> countriesCode = <String, String>{
  'AD': 'Andorra',
