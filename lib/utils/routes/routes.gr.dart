...
import '../../ui/pages/settings_page/saved_places_page/saved_places_page_ui.dart'
    as _i2;
import '../../ui/pages/settings_page/themes_page/theme_page_ui.dart' as _i7;
...
class AppRouter extends _i10.RootStackRouter {
  ...
  final Map<String, _i10.PageFactory> pagesMap = {
    ...
    SavedPlacesRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: _i2.SavedPlacesPage());
    },
    WeatherLanguageRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: _i3.WeatherLanguagePage());
    },
    UserApiRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: _i5.UserApiPage());
    },
    CountryFlagsRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: _i6.CountryFlagsPage());
    },
    ThemeRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: _i7.ThemePage());
    },
    VisualDesignRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: _i8.VisualDesignPage());
    },
    GratitudeRoute.name: (routeData) {
      return _i10.MaterialPageX<dynamic>(
          routeData: routeData, child: _i9.GratitudePage());
    }
  };
  ...
  List<_i10.RouteConfig> get routes => [
        ...
        _i10.RouteConfig(SavedPlacesRoute.name, path: '/saved-places-page'),
        _i10.RouteConfig(WeatherLanguageRoute.name,
            path: '/weather-language-page'),
        _i10.RouteConfig(UserApiRoute.name, path: '/user-api-page'),
        _i10.RouteConfig(CountryFlagsRoute.name, path: '/country-flags-page'),
        _i10.RouteConfig(ThemeRoute.name, path: '/theme-page'),
        _i10.RouteConfig(VisualDesignRoute.name, path: '/visual-design-page'),
        _i10.RouteConfig(GratitudeRoute.name, path: '/gratitude-page')
      ];
}
...
class SavedPlacesRoute extends _i10.PageRouteInfo<void> {
  const SavedPlacesRoute()
      : super(SavedPlacesRoute.name, path: '/saved-places-page');
...
class WeatherLanguageRoute extends _i10.PageRouteInfo<void> {
  const WeatherLanguageRoute()
      : super(WeatherLanguageRoute.name, path: '/weather-language-page');
...
class UserApiRoute extends _i10.PageRouteInfo<void> {
  const UserApiRoute() : super(UserApiRoute.name, path: '/user-api-page');

  static const String name = 'UserApiRoute';
}

/// generated route for
/// [_i6.CountryFlagsPage]
class CountryFlagsRoute extends _i10.PageRouteInfo<void> {
  const CountryFlagsRoute()
      : super(CountryFlagsRoute.name, path: '/country-flags-page');
...
class GratitudeRoute extends _i10.PageRouteInfo<void> {
  const GratitudeRoute() : super(GratitudeRoute.name, path: '/gratitude-page');
