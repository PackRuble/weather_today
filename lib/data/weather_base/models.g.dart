...
_WeatherUnits _$WeatherUnitsFromJson(Map<String, dynamic> json) => _WeatherUnits(
  temp: $enumDecodeNullable(_$TempEnumMap, json['temp']) ?? Temp.celsius,
  speed: $enumDecodeNullable(_$SpeedEnumMap, json['speed']) ?? Speed.ms,
  pressure: $enumDecodeNullable(_$PressureEnumMap, json['pressure']) ?? Pressure.mmHg,
);

Map<String, dynamic> _$WeatherUnitsToJson(_WeatherUnits instance) => <String, dynamic>{
...
_CurrentWeatherBase _$CurrentWeatherBaseFromJson(Map<String, dynamic> json) => _CurrentWeatherBase(
  units: json['units'] == null
      ? const WeatherUnits()
      : WeatherUnits.fromJson(json['units'] as Map<String, dynamic>),
  provider: $enumDecode(_$WeatherProviderEnumMap, json['provider']),
  datetime: const DateTimeISO8601Converter().fromJson(json['time'] as String),
...
Map<String, dynamic> _$CurrentWeatherBaseToJson(_CurrentWeatherBase instance) => <String, dynamic>{
