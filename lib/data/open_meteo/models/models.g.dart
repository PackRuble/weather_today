...
_ForecastOpenMeteoResponse _$ForecastOpenMeteoResponseFromJson(
...
Map<String, dynamic> _$ForecastOpenMeteoResponseToJson(
  _ForecastOpenMeteoResponse instance,
) => <String, dynamic>{
...
_CurrentWeatherOpenMeteo _$CurrentWeatherOpenMeteoFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$CurrentWeatherOpenMeteoToJson(
  _CurrentWeatherOpenMeteo instance,
) => <String, dynamic>{
  ...
  'weather_code': const OpenMeteoWeatherCodeConverter().toJson(
    instance.weatherCode,
  ),
};

_HourlyWeatherOpenMeteo _$HourlyWeatherOpenMeteoFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$HourlyWeatherOpenMeteoToJson(
  _HourlyWeatherOpenMeteo instance,
) => <String, dynamic>{
  'time': const DateTimeISO8601Converter().toJson(instance.time),
  'temperature_2m': instance.temp2m,
  'relative_humidity_2m': instance.relativeHumidity2m,
...
_DailyWeatherOpenMeteo _$DailyWeatherOpenMeteoFromJson(
  Map<String, dynamic> json,
  ...
  windDirection10mDominant: (json['wind_direction_10m_dominant'] as num)
      .toInt(),
  weatherCode: const OpenMeteoWeatherCodeConverter().fromJson(
    (json['weather_code'] as num).toInt(),
  ),
...
Map<String, dynamic> _$DailyWeatherOpenMeteoToJson(
  _DailyWeatherOpenMeteo instance,
) => <String, dynamic>{
  'time': const DateTimeISO8601Converter().toJson(instance.time),
  ...
  'daylight_duration': const DurationSecConverter().toJson(
    instance.daylightDur,
  ),
...
_OpenMeteoPlace _$OpenMeteoPlaceFromJson(Map<String, dynamic> json) =>
    _OpenMeteoPlace(
      ...
      postcodes:
          (json['postcodes'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
...
Map<String, dynamic> _$OpenMeteoPlaceToJson(_OpenMeteoPlace instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'latitude': instance.latitude,
