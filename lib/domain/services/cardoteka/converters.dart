...
class PlaceConverter extends Converter<Place, String> {
  ...
  @override
  Place from(String element) => Place.fromJson(jsonDecode(element) as Map<String, dynamic>);
...
class ForecastOpenMeteoResponseConverter extends Converter<ForecastOpenMeteoResponse, String> {
  const ForecastOpenMeteoResponseConverter();

  @override
  ForecastOpenMeteoResponse from(String element) =>
      ForecastOpenMeteoResponse.fromJson(jsonDecode(element) as Map<String, dynamic>);
